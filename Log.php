...
class Log
{
    ...
    protected function getMetaFile($date='')
    {
        ...
        return realpath(self::getDefaultSaveDir()) . DIRECTORY_SEPARATOR .'panda_meta_' . $now . '.idx';
    }
    ...
    public function getLogFile($date=''){
        ...
        return realpath(self::getDefaultSaveDir()) . DIRECTORY_SEPARATOR .'panda_data_'. $now . '.pda';
    }

    public static function getDefaultSaveDir(){
        $default_url = \Yii::getAlias(self::$default_save_dir);
        return $default_url;
    }

    public static function setDefaultSaveDir($log_dir){
